...
export function FrostedSettingsModal({ isOpen, onClose, currentCloak, onSelectCloak }: Props) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 p-4 backdrop-blur-md animate-in fade-in duration-200 font-sans">
      <div className="w-full max-w-lg overflow-hidden rounded-2xl border border-neutral-800 bg-[#0a0a0a] shadow-2xl backdrop-blur-xl">
        <div className="flex items-center justify-between border-b border-neutral-800 px-6 py-4">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              ...
              <p className="text-xs text-neutral-400">Manage tab cloaking and panic controls</p>
            </div>
          </div>
          <button
            onClick={onClose}
        ...
        <div className="space-y-6 p-6">
          ...
          <div className="rounded-xl border border-neutral-800 bg-black p-4">
            ...
            <p className="text-xs text-neutral-400 leading-relaxed">
              Pressing the{" "}
              <kbd className="rounded border border-neutral-700 bg-neutral-900 px-1.5 py-0.5 text-[10px] font-mono text-white">
                Esc
              </kbd>{" "}
