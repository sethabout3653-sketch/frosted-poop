  ...
  messages.set("general", [
    {
      ...
      avatarColor: "#5865f2",
      content: "Welcome to the Frosted Discord Chat! 🎉 Sign in or register an account to chat and join live voice channels with other players.",
  ...
  messages.set("announcements", [
    {
      ...
      displayName: "Frosted Bot",
      avatarColor: "#5865f2",
      content: "🚀 Discord Real-Time Text & Voice Chat is live! Real audio streaming, status indicators, custom attachments, and reactions are fully supported.",
