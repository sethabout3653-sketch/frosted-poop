!(function (e, t) {
  "object" == typeof exports && "undefined" != typeof module
    ...
    : "function" == typeof define && define.amd
      ? define(["exports"], t)
      : t(((e = "undefined" != typeof globalThis ? globalThis : e || self).BareMux = {}));
})(this, function (e) {
  "use strict";
    ...
    try {
      ...
      if (e instanceof AggregateError)
        throw (
          ...
          new Error("All clients returned an invalid MessagePort.", { cause: e })
        );
      return (
        console.warn(
      ...
      for (let e = 0; ; e++) {
        let t = (
            await this.worker.sendMessage(
              {
                type: "fetch",
                fetch: { remote: c.toString(), method: a.method, headers: o, body: n || void 0 },
              },
              n ? [n] : [],
            )
          ).fetch,
          s = new Response(b.includes(t.status) ? void 0 : t.body, {
        ...
        if (!y.includes(s.status)) return s;
        switch (i) {
          case "follow": {
