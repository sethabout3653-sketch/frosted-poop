...
(() => {
  ...
  var et = (s, t) => () => (t || s((t = { exports: {} }).exports, t), t.exports);
  var tt = (s, t, r, e) => {
    if ((t && typeof t == "object") || typeof t == "function")
      for (let n of Je(t))
        !Ze.call(s, n) &&
          n !== r &&
          K(s, n, { get: () => t[n], enumerable: !(e = ze(t, n)) || e.enumerable });
    return s;
  };
  var m = (s, t, r) => (
    (r = s != null ? Qe(Ye(s)) : {}),
    tt(t || !s || !s.__esModule ? K(r, "default", { value: s, enumerable: !0 }) : r, s)
  );
  var f = et((ut, k) => {
    "use strict";
    ...
    function J(s) {
      return s._maxListeners === void 0 ? d.defaultMaxListeners : s._maxListeners;
    }
    ...
    d.prototype.emit = function (t) {
      ...
      else for (var u = l.length, h = re(l, u), e = 0; e < u; ++e) X(h[e], this, r);
      return !0;
    };
    function Y(s, t, r, e) {
      var n, o, i;
      if (
        ...
        o === void 0
          ...
          : (o.newListener !== void 0 &&
              (s.emit("newListener", t, r.listener ? r.listener : r), (o = s._events)),
            (i = o[t])),
        i === void 0)
      )
        ((i = o[t] = r), ++s._eventsCount);
      else if (
        (typeof i == "function" ? (i = o[t] = e ? [r, i] : [i, r]) : e ? i.unshift(r) : i.push(r),
        (n = J(s)),
    ...
    d.prototype.removeListener = function (t, r) {
      ...
      if (e === r || e.listener === r)
        --this._eventsCount === 0
          ...
          : (delete n[t], n.removeListener && this.emit("removeListener", t, e.listener || r));
    ...
    d.prototype.removeAllListeners = function (t) {
      ...
      if (e.removeListener === void 0)
        return (
          arguments.length === 0
            ? ((this._events = Object.create(null)), (this._eventsCount = 0))
            : e[t] !== void 0 &&
              (--this._eventsCount === 0 ? (this._events = Object.create(null)) : delete e[t]),
          this
        );
      ...
      else if (r !== void 0) for (n = r.length - 1; n >= 0; n--) this.removeListener(t, r[n]);
      return this;
    };
    function ee(s, t, r) {
      var e = s._events;
    ...
    d.listenerCount = function (s, t) {
      return typeof s.listenerCount == "function" ? s.listenerCount(t) : te.call(s, t);
    };
    ...
    function it(s) {
      for (var t = new Array(s.length), r = 0; r < t.length; ++r) t[r] = s[r].listener || s[r];
      return t;
    }
    function st(s, t) {
  ...
  var S = class {
      ...
      constructor(t = {}, r = null, e = null) {
        ((this.#e = !1), (this.#t = null), (this.data = t), (this.target = r), (this.that = e));
      }
      get intercepted() {
        return this.#e;
      }
  ...
  var E = class extends ne.default {
      ...
      overrideParseFromString() {
        this.ctx.override(this.domProto, "parseFromString", (t, r, e) => {
          ...
          return (
            ...
            i.intercepted ? i.returnValue : i.target.call(i.that, i.data.string, i.data.type)
          );
        });
      }
      overrideQuerySelector() {
        this.ctx.override(this.docProto, "querySelector", (t, r, e) => {
          ...
          return (
            ...
            o.intercepted ? o.returnValue : o.target.call(o.that, o.data.selectors)
          );
        });
      }
      overrideDomain() {
        this.ctx.overrideDescriptor(this.docProto, "domain", {
          get: (t, r) => {
            ...
            return (this.emit("getDomain", e), e.intercepted ? e.returnValue : e.data.value);
          },
          set: (t, r, [e]) => {
      ...
      overrideReferrer() {
        this.ctx.overrideDescriptor(this.docProto, "referrer", {
          get: (t, r) => {
            let e = new a({ value: t.call(r) }, t, r);
            return (this.emit("referrer", e), e.intercepted ? e.returnValue : e.data.value);
          },
        });
      }
      overrideCreateTreeWalker() {
        this.ctx.override(this.docProto, "createTreeWalker", (t, r, e) => {
          ...
          let [n, o = 4294967295, i, c] = e,
            l = new a({ root: n, show: o, filter: i, expandEntityReferences: c }, t, r);
          return (
      ...
      overrideDocumentURI() {
        this.ctx.overrideDescriptor(this.docProto, "documentURI", {
          get: (t, r) => {
            let e = new a({ value: t.call(r) }, t, r);
            return (this.emit("documentURI", e), e.intercepted ? e.returnValue : e.data.value);
          },
        });
      }
      overrideURL() {
        this.ctx.overrideDescriptor(this.docProto, "URL", {
          get: (t, r) => {
            let e = new a({ value: t.call(r) }, t, r);
            return (this.emit("url", e), e.intercepted ? e.returnValue : e.data.value);
          },
        });
      }
      overrideCookie() {
        this.ctx.overrideDescriptor(this.docProto, "cookie", {
          get: (t, r) => {
            let e = new a({ value: t.call(r) }, t, r);
            return (this.emit("getCookie", e), e.intercepted ? e.returnValue : e.data.value);
          },
          set: (t, r, [e]) => {
            let n = new a({ value: e }, t, r);
            return (
      ...
      overrideTitle() {
        this.ctx.overrideDescriptor(this.docProto, "title", {
          get: (t, r) => {
            let e = new a({ value: t.call(r) }, t, r);
            return (this.emit("getTitle", e), e.intercepted ? e.returnValue : e.data.value);
          },
          set: (t, r, [e]) => {
            let n = new a({ value: e }, t, r);
            return (
  ...
  var O = class extends se.default {
        ...
        (this.ctx.override(this.elemProto, "getAttribute", (t, r, e) => {
          ...
          this.ctx.override(this.elemProto, "setAttribute", (t, r, e) => {
            ...
            return (
              ...
              i.intercepted ? i.returnValue : i.target.call(i.that, i.data.name, i.data.value)
            );
          }),
      ...
      overrideHtml() {
        (this.hookProperty(this.Element, "innerHTML", {
          get: (t, r) => {
            let e = new a({ value: t.call(r) }, t, r);
            return (this.emit("getInnerHTML", e), e.intercepted ? e.returnValue : e.data.value);
          },
          set: (t, r, [e]) => {
            let n = new a({ value: e }, t, r);
          ...
          this.hookProperty(this.Element, "outerHTML", {
            get: (t, r) => {
              let e = new a({ value: t.call(r) }, t, r);
              return (this.emit("getOuterHTML", e), e.intercepted ? e.returnValue : e.data.value);
            },
            set: (t, r, [e]) => {
              let n = new a({ value: e }, t, r);
      ...
      overrideInsertAdjacentHTML() {
        this.ctx.override(this.elemProto, "insertAdjacentHTML", (t, r, e) => {
          ...
          return (
            ...
            i.intercepted ? i.returnValue : i.target.call(i.that, i.data.position, i.data.html)
          );
        });
      }
      overrideInsertAdjacentText() {
        this.ctx.override(this.elemProto, "insertAdjacentText", (t, r, e) => {
          ...
          return (
            ...
            i.intercepted ? i.returnValue : i.target.call(i.that, i.data.position, i.data.text)
          );
        });
      }
      hookProperty(t, r, e) {
  ...
  var M = class extends ce.default {
      ...
      overrideTextContent() {
        this.ctx.overrideDescriptor(this.nodeProto, "textContent", {
          get: (t, r) => {
            let e = new a({ value: t.call(r) }, t, r);
            return (this.emit("getTextContent", e), e.intercepted ? e.returnValue : e.data.value);
          },
          set: (t, r, [e]) => {
            let n = new a({ value: e }, t, r);
      ...
      overrideBaseURI() {
        this.ctx.overrideDescriptor(this.nodeProto, "baseURI", {
          get: (t, r) => {
            let e = new a({ value: t.call(r) }, t, r);
            return (this.emit("baseURI", e), e.intercepted ? e.returnValue : e.data.value);
          },
        });
      }
      overrideParent() {
        (this.ctx.overrideDescriptor(this.nodeProto, "parentNode", {
          get: (t, r) => {
            ...
            return (this.emit("parentNode", e), e.intercepted ? e.returnValue : e.data.node);
          },
        }),
          this.ctx.overrideDescriptor(this.nodeProto, "parentElement", {
            get: (t, r) => {
              let e = new a({ element: t.call(r) }, t, r);
              return (this.emit("parentElement", e), e.intercepted ? e.returnValue : e.data.node);
            },
          }));
      }
      overrideOwnerDocument() {
        this.ctx.overrideDescriptor(this.nodeProto, "ownerDocument", {
          get: (t, r) => {
            ...
            return (this.emit("ownerDocument", e), e.intercepted ? e.returnValue : e.data.document);
          },
        });
      }
      overrideCompareDocumentPosit1ion() {
        this.ctx.override(this.nodeProto, "compareDocumentPosition", (t, r, e) => {
          ...
          let [n] = e,
            o = new a({ node: n }, t, r);
          return o.intercepted ? o.returnValue : o.target.call(o.that, o.data.node);
        });
      }
  ...
  var L = class extends he.default {
      ...
      overrideNameValue() {
        (this.ctx.overrideDescriptor(this.attrProto, "name", {
          get: (t, r) => {
            let e = new a({ value: t.call(r) }, t, r);
            return (this.emit("name", e), e.intercepted ? e.returnValue : e.data.value);
          },
        }),
          this.ctx.overrideDescriptor(this.attrProto, "value", {
            get: (t, r) => {
              let e = new a({ name: this.name.get.call(r), value: t.call(r) }, t, r);
              return (this.emit("getValue", e), e.intercepted ? e.returnValue : e.data.value);
            },
            set: (t, r, [e]) => {
        ...
        this.ctx.override(
          ...
          (t, r, e) => {
            ...
            return (
              ...
              i.intercepted ? i.returnValue : i.target.call(i.that, ...i.data.args, i.data.script)
            );
          },
          !0,
        );
      ...
      overrideRequest() {
        return this.fetch
          ? (this.ctx.override(this.window, "fetch", (t, r, e) => {
              if (!e.length || e[0] instanceof this.Request) return t.apply(r, e);
              let [n, o = {}] = e,
                i = new a({ input: n, options: o }, t, r);
              return (
                this.emit("request", i),
                i.intercepted ? i.returnValue : i.target.call(i.that, i.data.input, i.data.options)
              );
            }),
            this.ctx.override(
              this.window,
              ...
              (t, r, e) => {
                ...
                return (
                  this.emit("request", i),
                  i.intercepted ? i.returnValue : new i.target(i.data.input, i.data.options)
                );
              },
              !0,
            ),
      ...
      overrideUrl() {
        return (
          this.ctx.overrideDescriptor(this.reqProto, "url", {
            get: (t, r) => {
              let e = new a({ value: t.call(r) }, t, r);
              return (this.emit("requestUrl", e), e.intercepted ? e.returnValue : e.data.value);
            },
          }),
          this.ctx.overrideDescriptor(this.resProto, "url", {
            get: (t, r) => {
              let e = new a({ value: t.call(r) }, t, r);
              return (this.emit("responseUrl", e), e.intercepted ? e.returnValue : e.data.value);
            },
          }),
          !0
        );
        ...
        return this.Headers
          ? (this.ctx.overrideDescriptor(this.reqProto, "headers", {
            ...
            this.ctx.override(this.headersProto, "has", (t, r, e) => {
              ...
              return (this.emit("hasHeader", o), o.intercepted ? o.returnValue : o.data);
            }),
      ...
      overrideOpen() {
        this.ctx.override(this.xhrProto, "open", (t, r, e) => {
          ...
          let [n, o, i = !0, c = null, l = null] = e,
            u = new a({ method: n, input: o, async: i, user: c, password: l }, t, r);
          return (
            this.emit("open", u),
            u.intercepted
              ? u.returnValue
        ...
        (this.ctx.override(
          ...
          (t, r, e) => {
            ...
            return (
              ...
              i.intercepted ? i.returnValue : new i.target(i.data.url, i.data.config)
            );
          },
          !0,
        ),
  ...
  var I = class extends xe.default {
      ...
      overrideForward() {
        this.ctx.override(this.historyProto, "forward", (t, r) => {
          ...
          return (this.emit("forward", e), e.intercepted ? e.returnValue : e.target.call(e.that));
        });
      }
      overrideBack() {
        this.ctx.override(this.historyProto, "back", (t, r) => {
          let e = new a(null, t, r);
          return (this.emit("back", e), e.intercepted ? e.returnValue : e.target.call(e.that));
        });
      }
    },
    ke = I;
  ...
  var H = class extends Oe.default {
      ...
      overridePostMessage() {
        this.ctx.override(this.window, "postMessage", (t, r, e) => {
          ...
          let c = new a({ message: n, origin: o, transfer: i, worker: this.ctx.worker }, t, r);
          return (
            ...
            c.intercepted
              ...
              : this.ctx.worker
                ...
                : c.target.call(c.that, c.data.message, c.data.origin, c.data.transfer)
          );
        });
      }
      wrapPostMessage(t, r, e = !1) {
        return this.ctx.wrap(t, r, (n, o, i) => {
          ...
          let h = new a({ message: c, origin: l, transfer: u, worker: this.ctx.worker }, n, t);
          return (
            ...
            h.intercepted
              ...
              : e
                ...
                : h.target.call(h.that, h.data.message, h.data.origin, h.data.transfer)
          );
        });
      }
      overrideMessageOrigin() {
        this.ctx.overrideDescriptor(this.messageProto, "origin", {
          get: (t, r) => {
            let e = new a({ value: t.call(r) }, t, r);
            return (this.emit("origin", e), e.intercepted ? e.returnValue : e.data.value);
          },
        });
      }
      overrideMessageData() {
        this.ctx.overrideDescriptor(this.messageProto, "data", {
          get: (t, r) => {
            let e = new a({ value: t.call(r) }, t, r);
            return (this.emit("data", e), e.intercepted ? e.returnValue : e.data.value);
          },
        });
      }
    },
      ...
      overrideSendBeacon() {
        this.ctx.override(this.navProto, "sendBeacon", (t, r, e) => {
          ...
          return (
            ...
            i.intercepted ? i.returnValue : i.target.call(i.that, i.data.url, i.data.data)
          );
        });
      }
    },
  ...
  async function W() {
    let s = (await self.clients.matchAll({ type: "window", includeUncontrolled: !0 })).map(
        async (r) => {
  ...
  function Ie(s) {
    ...
    return (v.call(s, { message: { type: "ping" }, port: t.port2 }, [t.port2]), r);
  }
  function Ve(s, t) {
  ...
  var b = class {
    ...
    async setManualTransport(t, r, e) {
      ...
      await this.worker.sendMessage({ type: "set", client: { function: t, args: r } }, e);
    }
    async setRemoteTransport(t, r) {
      ...
      ((e.port1.onmessage = async (n) => {
          ...
          try {
            (t.ready || (await t.init()),
              await (async function (c, l, u) {
                ...
                h.body instanceof ReadableStream || h.body instanceof ArrayBuffer
            ...
            (t.ready || (await t.init()),
              await (async function (c, l, u) {
                let [h, w] = u.connect(
                  ...
                  (p) => {
                    p instanceof ArrayBuffer
                      ? v.call(c.websocket.channel, { type: "message", args: [p] }, [p])
                      : v.call(c.websocket.channel, { type: "message", args: [p] });
                  },
                  (p, Xe) => {
                    v.call(c.websocket.channel, { type: "close", args: [p, Xe] });
                  },
                  (p) => {
                ...
                ((c.websocket.channel.onmessage = (p) => {
                  p.data.type === "data"
                    ? h(p.data.data)
                    : p.data.type === "close" && w(p.data.closeCode, p.data.closeReason);
                }),
        ...
        await this.worker.sendMessage(
          { type: "set", client: { function: "bare-mux-remote", args: [e.port2, r] } },
          [e.port2],
        ));
    }
    getInnerPort() {
      ...
      overrideAddModule() {
        this.ctx.override(this.workletProto, "addModule", (t, r, e) => {
          ...
          return (
            ...
            i.intercepted ? i.returnValue : i.target.call(i.that, i.data.url, i.data.options)
          );
        });
      }
      overridePostMessage() {
        this.ctx.override(this.workerProto, "postMessage", (t, r, e) => {
          ...
          return (
            ...
            i.intercepted ? i.returnValue : i.target.call(i.that, i.data.message, i.data.transfer)
          );
        });
      }
      ...
      overrideMethods() {
        (this.ctx.override(this.storeProto, "getItem", (t, r, e) => {
          ...
          this.ctx.override(this.storeProto, "clear", (t, r) => {
            ...
            return (this.emit("clear", e), e.intercepted ? e.returnValue : e.target.call(e.that));
          }),
          this.ctx.override(this.storeProto, "key", (t, r, e) => {
            ...
            return (
              this.emit("key", o),
              o.intercepted ? o.returnValue : o.target.call(o.that, o.data.index)
            );
          }));
      }
      overrideLength() {
        this.ctx.overrideDescriptor(this.storeProto, "length", {
          get: (t, r) => {
            ...
            return (this.emit("length", e), e.intercepted ? e.returnValue : e.data.length);
          },
        });
      }
      emulate(t, r = {}) {
        ...
        let e = new this.ctx.window.Proxy(r, {
          get: (n, o) => {
            ...
            return (this.emit("get", i), i.intercepted ? i.returnValue : t[i.data.name]);
          },
          set: (n, o, i) => {
          ...
          deleteProperty: (n, o) => {
            ...
            let i = new a({ name: o }, null, t);
            return (this.emit("delete", i), i.intercepted ? i.returnValue : delete t[i.data.name]);
          },
        });
        return (
      ...
      overrideSetGetProperty() {
        (this.ctx.override(this.cssStyleProto, "getPropertyValue", (t, r, e) => {
          ...
          return (
            ...
            o.intercepted ? o.returnValue : o.target.call(o.that, o.data.property)
          );
        }),
          this.ctx.override(this.cssStyleProto, "setProperty", (t, r, e) => {
            ...
            return (
              ...
              i.intercepted ? i.returnValue : i.target.call(i.that, i.data.property, i.data.value)
            );
          }));
      }
      overrideCssText() {
        this.ctx.overrideDescriptor(this.cssStyleProto, "cssText", {
          get: (t, r) => {
            let e = new a({ value: t.call(r) }, t, r);
            return (this.emit("getCssText", e), e.intercepted ? e.returnValue : e.data.value);
          },
          set: (t, r, [e]) => {
            let n = new a({ value: e }, t, r);
            return (
      ...
      overrideOpen() {
        this.ctx.override(this.IDBFactory.prototype, "open", (t, r, e) => {
          ...
          return (
            ...
            i.intercepted ? i.returnValue : i.target.call(i.that, i.data.name, i.data.version)
          );
        });
      }
      overrideName() {
        this.ctx.overrideDescriptor(this.idbDatabaseProto, "name", {
          get: (t, r) => {
            let e = new a({ value: t.call(r) }, t, r);
            return (this.emit("idbFactoryName", e), e.intercepted ? e.returnValue : e.data.value);
          },
        });
      }
    },
      ...
      overrideWebSocket(t) {
        (this.ctx.override(
          ...
          (r, e, n) => {
            ...
            (Object.setPrototypeOf(o, this.WebSocket.prototype), (o.constructor = this.WebSocket));
            let i = (h) =>
                new Proxy(h, {
                  get(w, p) {
              ...
              l = { extensions: "", protocol: "", url: n[0], binaryType: "blob", barews: c };
            function u(h) {
          ...
          this.ctx.overrideDescriptor(this.wsProto, "binaryType", {
            ...
            set: (r, e, n) => {
              ...
              (n[0] === "blob" || n[0] === "arraybuffer") && (o.binaryType = n[0]);
            },
          }),
          this.ctx.overrideDescriptor(this.wsProto, "bufferedAmount", { get: (r, e) => 0 }),
