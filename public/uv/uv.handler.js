...
(() => {
  ...
  function p(o) {
    ...
    o.document &&
      o.window &&
      o.document.querySelectorAll("script[__uv-script]").forEach((t) => t.remove());
    let h = !o.window,
      b = "__uv",
      i = "__uv$",
      e = new m(A),
    ...
    (a.nativeMethods.defineProperty(e.meta, "base", {
      ...
      a.workers.on("postMessage", (t) => {
        let r = t.data.origin;
        ((t.data.origin = "*"),
          (t.data.message = { __data: t.data.message, __origin: e.meta.url.origin, __to: r }));
      }),
      ...
      a.history.on("replaceState", (t) => {
        t.data.url &&
          (t.data.url = e.rewriteUrl(t.data.url, "__uv" in t.that ? t.that.__uv.meta : e.meta));
      }),
      ...
      a.element.on("getAttribute", (t) => {
        a.element.hasAttribute.call(t.that, e.attributePrefix + "-attr-" + t.data.name) &&
      ...
      a.element.hookProperty([y, M, j, g, _, v, H, n, x, S], "src", {
        get: (t, r) => e.sourceUrl(t.call(r)),
        set: (t, r, [l]) => {
          if (new String(l).toString().trim().startsWith("blob:") && r instanceof g)
            return (
      ...
      a.element.hookProperty([_, S], "srcset", {
        get: (t, r) =>
          a.element.getAttribute.call(r, e.attributePrefix + "-attr-srcset") || t.call(r),
        set: (t, r, [l]) => {
      ...
      a.element.hookProperty(n, "sandbox", {
        get: (t, r) =>
          a.element.getAttribute.call(r, e.attributePrefix + "-attr-sandbox") || t.call(r),
        set: (t, r, [l]) => {
    ...
    if (
      (a.element.hookProperty(n, "contentWindow", { get: (t, r) => (U(r), t.call(r)) }),
      a.element.hookProperty(n, "contentDocument", { get: (t, r) => (U(r), t.call(r)) }),
        ...
        if (t.that.__uv$storageObj)
          for (let r of a.nativeMethods.keys.call(null, t.that.__uv$storageObj))
            (delete t.that.__uv$storageObj[r],
              a.storage.removeItem.call(t.that, i + e.meta.url.origin + "@" + r),
              t.respondWith());
      }),
      ...
      a.storage.on("key", (t) => {
        t.that.__uv$storageObj &&
          t.respondWith(
            a.nativeMethods.keys.call(null, t.that.__uv$storageObj)[t.data.index] || null,
          );
      }),
      ...
      a.style.on("getPropertyValue", (t) => {
        a.style.dashedUrlProps.includes(t.data.property) &&
          t.respondWith(
            e.sourceCSS(t.target.call(t.that, t.data.property), { context: "value", ...e.meta }),
          );
      }),
      "CSS2Properties" in o)
    )
    ...
    (a.style.on("setCssText", (t) => {
      ...
      a.location.on("hashchange", (t, r, l) => {
        if (l.HashChangeEvent && a.history.replaceState) {
          ...
          (a.nativeMethods.defineProperty(s, i + "dispatched", { value: !0, enumerable: !1 }),
      ...
      a.nativeMethods.defineProperty(o.Object.prototype, b, { get: () => e, enumerable: !1 }),
