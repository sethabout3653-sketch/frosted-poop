...
export declare const Object_getOwnPropertyDescriptor: (
  o: any,
  p: PropertyKey,
) => PropertyDescriptor | undefined;
export declare const Object_getOwnPropertyDescriptors: <T>(o: T) => {
  [P in keyof T]: TypedPropertyDescriptor<T[P]>;
} & {
  [x: string]: PropertyDescriptor;
};
export declare const Object_getOwnPropertySymbols: (o: any) => symbol[];
export declare const Object_defineProperty: <T>(
  o: T,
  p: PropertyKey,
  attributes: PropertyDescriptor & ThisType<any>,
) => T;
export declare const Object_defineProperties: <T>(
  o: T,
...
export declare const JSON_parse: (
  text: string,
...
type ConstructorPrototype<T> = T extends {
  ...
  ? P
  : never;
type InstantiatePrototype<P, Params extends unknown[]> = Params extends [infer A, infer B]
...
type WrappedCtor<T, Params extends unknown[], New extends abstract new (...a: any) => any> = New &
...
type WrappedConstructor<T> =
  ConstructorPrototype<T> extends Map<any, any>
    ? T extends {
      ...
      ? WrappedCtor<T, [unknown, unknown], new <K, V>(...args: Args) => Wrapped<Map<K, V>>>
      : never
    : ConstructorPrototype<T> extends WeakMap<any, any>
      ...
      : ConstructorPrototype<T> extends WeakSet<any>
        ? T extends {
          ...
          ? WrappedCtor<T, [object], new <U extends object>(...args: Args) => Wrapped<WeakSet<U>>>
          : never
        : ConstructorPrototype<T> extends Set<any>
          ...
          : T extends {
            ...
            ? WrappedCtor<
                ...
                new <K, V>(
                  ...args: Args
                ) => Wrapped<InstantiatePrototype<ConstructorPrototype<T>, [K, V]>>
              >
            : T extends {
                  new <U>(...args: infer Args): any;
                }
              ? WrappedCtor<
                  ...
                  new <U>(
                    ...args: Args
                  ) => Wrapped<InstantiatePrototype<ConstructorPrototype<T>, [U]>>
                >
...
export declare const _Date: WrappedCtor<
  DateConstructor,
  [unknown, unknown],
  new <K, V>(
...
export declare const _URLSearchParams: WrappedCtor<
  ...
  [unknown, unknown],
  new <K, V>(
    init?: string | Record<string, string> | URLSearchParams | string[][],
  ) => URLSearchParams & {
    readonly [WrappedBrand]: URLSearchParams;
  }
>;
export type _URLSearchParams = Wrapped<URLSearchParams>;
export declare const _RegExp: WrappedCtor<
  RegExpConstructor,
  [unknown, unknown],
  new <K, V>(
...
export declare const _Set: WrappedCtor<
  SetConstructor,
  [object],
  new <U extends object>(
...
export declare const _Map: WrappedCtor<
  MapConstructor,
  [unknown, unknown],
  new <K, V>(
...
export declare const _WeakSet: WrappedCtor<
  WeakSetConstructor,
  [object],
  new <U extends object>(
    iterable: Iterable<WeakKey>,
  ) => WeakSet<U> & {
    readonly [WrappedBrand]: WeakSet<U>;
  }
>;
export type _WeakSet<T extends object> = Wrapped<WeakSet<T>>;
export declare const _WeakMap: WrappedCtor<
  WeakMapConstructor,
  [WeakKey, unknown],
  new <K extends WeakKey, V>(
    iterable: Iterable<readonly [WeakKey, unknown]>,
  ) => WeakMap<K, V> & {
    readonly [WrappedBrand]: WeakMap<K, V>;
  }
>;
export type _WeakMap<K extends object, V extends object> = Wrapped<WeakMap<K, V>>;
export declare const _Uint8Array: WrappedCtor<
  Uint8ArrayConstructor,
  [unknown, unknown],
  new <K, V>() => Uint8Array<ArrayBufferLike> & {
