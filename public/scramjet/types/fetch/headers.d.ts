...
export declare function rewriteResponseHeaders(
  handler: ScramjetFetchHandler,
  request: ScramjetFetchRequest,
  parsed: ScramjetFetchParsed,
  rawHeaders: RawHeaders,
): Promise<ScramjetHeaders>;
export declare function rewriteRequestHeaders(
  request: ScramjetFetchRequest,
  handler: ScramjetFetchHandler,
  parsed: ScramjetFetchParsed,
): ScramjetHeaders;
 ...
 */
export declare function computeFetchSite(
  originUrl: URL,
  destUrl: URL,
 ...
 */
export declare function worstFetchSite(
