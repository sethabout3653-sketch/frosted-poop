...
(() => {
  ...
  ((() => {
    ...
    function n(e) {
      ...
      return void 0 !== i.find((e) => t.pathname.startsWith(e.prefix)) || (t.pathname.startsWith("/~/sj/") && i.length > 0);
    }
    async function a(e) {
      try {
        let t = new URL(e.request.url),
          r = i.find((e) => t.pathname.startsWith(e.prefix)) || (t.pathname.startsWith("/~/sj/") ? i[i.length - 1] : void 0);
        if (!r) {
        ...
        let isNullBody = [101, 204, 205, 304].includes(n.status);
        return new Response(isNullBody ? null : n.body, {
          status: n.status,
